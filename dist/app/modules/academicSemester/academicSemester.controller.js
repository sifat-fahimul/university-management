...
const createAcademicSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield academicSemester_service_1.AcademicSemestersService.createSemester(
        payload
      );
...
const getAllSemesters = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const paginationOptions = (0, pick_1.default)(
      req.query,
      pagination_1.paginationKey
    );
    const result =
      yield academicSemester_service_1.AcademicSemestersService.getAllSemesters(
        filters,
        paginationOptions
      );
    (0, sendResponse_1.default)(res, {
...
const getSingleSemesters = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield academicSemester_service_1.AcademicSemestersService.getSingleSemesters(
        id
      );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
...
const updateSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const body = req.body;
    const result =
      yield academicSemester_service_1.AcademicSemestersService.updateSemester(
        id,
        body
      );
    (0, sendResponse_1.default)(res, {
...
const deleteSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result =
      yield academicSemester_service_1.AcademicSemestersService.deleteSemester(
        id
      );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
