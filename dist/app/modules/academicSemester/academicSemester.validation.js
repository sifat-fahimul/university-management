...
const createAcademicSemesterZodSchema = zod_1.z.object({
  body: zod_1.z.object({
    title: zod_1.z.enum(
      [...academicSemester_constant_1.ACADEMIC_SEMESTER_TITLES],
      {
    ...
    code: zod_1.z.enum([
      ...academicSemester_constant_1.ACADEMIC_SEMESTER_CODES,
    ]),
    startMonth: zod_1.z.enum(
      [...academicSemester_constant_1.ACADEMIC_SEMESTER_MONTHS],
      {
