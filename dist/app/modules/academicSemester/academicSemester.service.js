...
exports.AcademicSemestersService = void 0;
...
const createSemester = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (academicSemester_constant_1.ACADEMIC_SEMESTER_TITLE_CODE_MAPPER[payload.title] !== payload.code) {
...
const updateSemester = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (payload.title &&
        payload.code &&
        academicSemester_constant_1.ACADEMIC_SEMESTER_TITLE_CODE_MAPPER[payload.title] !== payload.code) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Invalid semester code');
    }
...
exports.AcademicSemestersService = {
    createSemester,
    getAllSemesters,
    getSingleSemesters,
    updateSemester,
