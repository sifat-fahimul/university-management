...
const getAllAdmin = (filters, paginationOptions) =>
...
const updateAdmin = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const isExistAdmin = yield admin_model_1.Admin.findOne({ id });
    if (!isExistAdmin) {
...
const deleteAdmin = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield admin_model_1.Admin.findByIdAndDelete(id).populate(
      'managementDepartment'
    );
    return result;
  });
